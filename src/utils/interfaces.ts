...
export interface IUserContext {
  ...
  createProcesso: (processo: IProcesso, idEtapa: number, idEdicao: number) => Promise<void>,
  editProcesso: (processo: IProcesso, idEtapa: number, idEdicao: number) => Promise<void>,
